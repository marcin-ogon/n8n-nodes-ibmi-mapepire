...
export class MapepireApi implements ICredentialType {
	...
	properties: INodeProperties[] = [
		...
		},
		{
			...
			type: 'boolean',
			default: true,
			description: 'If true, accepts self‑signed or invalid certificates unless a CA is provided below',
		},
		{
			...
			type: 'string',
			default: '',
			description: 'Optional custom CA bundle in PEM format. When set, certificate verification is enforced',
		},
	];
}
